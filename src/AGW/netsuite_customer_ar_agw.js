      ...
      try {
        ...
        try {
          ...
          await sendDevNotification(
            source_system,
            "AR",
            "netsuite_customer_ar_ag for loop customer_id" + customer_id,
            singleItem,
            error
          );
        }
...
async function checkOldProcessIsRunning() {
  try {
    const customerArn = process.env.NETSUITE_AR_AGW_CUSTOMER_STEP_ARN;
